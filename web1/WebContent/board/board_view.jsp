...
<input type="button" value="목록보기"onclick="doMovePage('list')"/> <input type="button" value="뒤로가기"onclick="doMovePage('cancel')"/>
</div>
</div>
<script>
function deleteBoard(){
	var bipwd = document.getElementById("bipwd").value;
	location.href="<%=rootPath%>/board/board_delete_ok.jsp?binum=<%=binum%>&bipwd=" + bipwd; 
}

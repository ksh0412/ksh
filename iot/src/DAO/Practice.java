...
public class Practice {
	Connection con;
	Practice() throws ClassNotFoundException, SQLException{
		con = DBConn2.getCon();
	}
	public List<Map> getCommentList(int boardNum) throws SQLException{
		String sql = "select ci.ci_num,ci.content,ci.reg_date,b.title,u.name from comment_info as ci, board as b, user_info as u";

...
public class ArrExam2 {
	...
	//스트링 배열변수를 선언해주세요.
	//해당배열변수의 방의 갯수는 위에서 받아온 초기값과 맥스값으로 계산해야 에러가 나지않습니다.
	//해당반복문에서 Scanner클래스의 nextLine()함수를 사용하여 위에서 선언한
	//스트링배열변수에 0번째 인덱스부터 마지막 방의 인덱스까지 값을 받아주세요.
	...
	String[] str = new String[num2-num1];
	
	void input(){
		initNum=scan.nextLine();
		maxNum=scan.nextLine();
		for(int i=num1;i<num2;i++){
		System.out.println(str[num2-num1]);
		}	
	}	
	
	public static void main(String[] args){
		ArrExam2 ar = new ArrExam2();
		ar.input();
	}
}
